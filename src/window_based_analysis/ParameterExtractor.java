...
//				 FileWriter("./src/window_based_analysis/new_CodeSnippets/"+functionName+"CodeSnippets.txt",true);

//		FileWriter file = new FileWriter(
//				"./src/window_based_analysis/functions/curveParameterstemp.txt",
//				true);
		 
//		String toWrite = parameterArray.toString();
...
//		String temp = functionName + "(" + toWrite + ")";
//		file2.write(temp);
//		file2.write("\n");
//		
//		file2.flush();
